...
$msg = curl_menu(ACCESS_TOKEN, preg_replace("#\\\u([0-9a-f]+)#ie", "iconv('UCS-2BE', 'UTF-8', pack('H4', '\\1'))", $data));
//$msg = curl_menu(ACCESS_TOKEN, preg_replace("#\\\u([0-9a-f]+)#ie", "iconv('UCS-2LE', 'UTF-8', pack('H4', '\\1'))", $data));
//$msg = curl_menu(ACCESS_TOKEN, preg_replace("#\\\u([0-9a-f]+)#ie", "iconv('UCS-2', 'GBK', pack('H4','8F66'))", $data));
//$msg = curl_menu(ACCESS_TOKEN, preg_replace("#\\\u([0-9a-f]+)#ie", "iconv('UCS-2LE', 'GBK', pack('H4', '8F66'))", $data));
//$msg = curl_menu(ACCESS_TOKEN, preg_replace("#\\\u([0-9a-f]+)#ie", "iconv('UCS-2BE', 'GBK', pack('H4', '8F66'))", $data));
//$msg = curl_menu(ACCESS_TOKEN, preg_replace("#\\\u([0-9a-f]+)#ie", "iconv('UCS-2', 'gb2312', pack('H4', '\1'))", $data));
//$msg = curl_menu(ACCESS_TOKEN, preg_replace("#\\\u([0-9a-f]+)#ie", "iconv('UCS-2LE', 'gb2312', pack('H4', '\1'))", $data));
//$msg = curl_menu(ACCESS_TOKEN, preg_replace("#\\\u([0-9a-f]+)#ie", "iconv('UCS-2BE', 'gb2312', pack('H4', '\1'))", $data));
echo $msg;
echo $msg['errmsg'];
