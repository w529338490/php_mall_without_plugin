...
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','美乐乐第二版源码,高端大气行业ECSHOP商城模板,家具建材家居商城源码下载-其才网络','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','美乐乐网站模板源码第二版由其才网络出品，独家做后期修复升级，源码下载购买请加Q249699062','1');");
...
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','249699062','1');");
E_D("replace into `ecs_shop_config` values('110','1','ww','text','','','chinahcg,chinahcg:售前,chinahcg:售后','1');");
...
E_D("replace into `ecs_shop_config` values('114','1','service_email','text','','','249699062@qq.com','1');");
E_D("replace into `ecs_shop_config` values('115','1','service_phone','text','','','0527-82862887','1');");
