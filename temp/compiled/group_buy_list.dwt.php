...
?>
    <div class="tg_list">
      <div class="tg_goods" onMouseOver="this.className='tg_goods active';" onMouseOut="this.className='tg_goods';">
        ...
        <p class="tg_pic"> <a title="<?php if ($this->_var['group_buy']['group_title']): ?><?php echo $this->_var['group_buy']['group_title']; ?><?php else: ?><?php echo $this->_var['group_buy']['act_name']; ?><?php endif; ?>" target="_blank" href="<?php echo $this->_var['group_buy']['url']; ?>"><img width="266" height="266" alt="<?php if ($this->_var['group_buy']['group_title']): ?><?php echo $this->_var['group_buy']['group_title']; ?><?php else: ?><?php echo $this->_var['group_buy']['act_name']; ?><?php endif; ?>" src="themes/meilele/images/blank.gif" data-src="<?php echo $this->_var['group_buy']['group_img']; ?>"></a> <span class="tg_info"><span class="Left" id="over_time_<?php echo $this->_foreach['groupname']['iteration']; ?>" d='<?php echo $this->_var['group_buy']['gmt_time']; ?>'>0天0时0分0秒</span><span class="Right">已团购：<b id="JS_already_number_25544"><?php if ($this->_var['group_buy']['isg_rs'] == 1): ?><?php echo $this->_var['group_buy']['group_rs']; ?><?php else: ?><?php echo $this->_var['group_buy']['cur_amount']; ?><?php endif; ?></b>个</span></span> </p>
