...
#brandList .list,#brandList .hover{width:270px;height:370px;padding:15px;overflow:hidden;margin:10px 0 5px 40px;background:url(themes/meilele/images/index_bg.png) no-repeat;float:left;}
...
<div id="brandBanner" class="w"><img src="themes/meilele/images/index_banner_01.jpg" title="品牌展厅" alt="品牌展厅" height="79" width="980"><img src="themes/meilele/images/index_banner_02.jpg" title="品牌展厅" alt="品牌展厅" height="79" width="980"></div>
...
?>
  <div class="list <?php if ($this->_foreach['brand_list_foreach']['iteration'] % 3 == 1): ?>first<?php endif; ?>">
