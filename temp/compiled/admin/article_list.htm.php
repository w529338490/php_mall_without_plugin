...
?>
  <tr>
    ...
    <td align="center" nowrap="true"><span>
      <a href="<?php if ($this->_var['list']['cat_id'] == 12): ?>../xspace_show.php?id=<?php echo $this->_var['list']['article_id']; ?><?php else: ?>../article.php?id=<?php echo $this->_var['list']['article_id']; ?><?php endif; ?>" target="_blank" title="<?php echo $this->_var['lang']['view']; ?>"><img src="images/icon_view.gif" border="0" height="16" width="16" /></a>&nbsp;
